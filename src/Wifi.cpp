...
void Wifi::Reset()
{
    ...
    Firmware::FirmwareConsoleType console = static_cast<Firmware::FirmwareConsoleType>(fw.GetHeader().ConsoleType);
    if (console == Firmware::FirmwareConsoleType::DS)
        IOPORT(0x000) = 0x1440;
    else if (console == Firmware::FirmwareConsoleType::DSLite || console == Firmware::FirmwareConsoleType::iQueDSLite)
        IOPORT(0x000) = 0xC340;
